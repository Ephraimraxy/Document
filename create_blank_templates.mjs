...
// Create minimal blank XLSX  
const createBlankXlsx = async () => {
  const zip = new JSZip();
...
try {
  ...
  fs.writeFileSync('public/templates/blank.pptx', pptx);
  
  console.log('✓ Created blank.docx');
  console.log('✓ Created blank.xlsx');
  console.log('✓ Created blank.pptx');
